  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-[rgb(var(--fg-muted))]">Manage your profile, security, and appearance preferences.</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs uppercase tracking-wide text-[rgb(var(--fg-muted))]">{user?.role.replace("_", " ")}</p>
          </div>
        </CardContent>
      </Card>
